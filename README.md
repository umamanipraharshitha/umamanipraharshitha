...
| ------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| [**OCR Anomaly Detection Document Intelligence Pipeline**](https://github.com/umamanipraharshitha/OCR_anomaly_detection) | AI-powered OCR/ICR document intelligence system for automated extraction, anomaly detection, analytics, and reviewer feedback workflows. | FastAPI · React.js · Firebase · OCR · Tesseract · Azure OCR · Python · JavaScript |
